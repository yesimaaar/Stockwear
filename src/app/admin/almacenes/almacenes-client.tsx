...
import {
	...
	type AlmacenResumen
} from "@/features/movimientos/services/inventario-service"
...
export interface AlmacenesPageClientProps {
	initialAlmacenes: AlmacenResumen[]
}

export function AlmacenesPageClient({ initialAlmacenes }: AlmacenesPageClientProps) {
	const { toast } = useToast()
	const [almacenes, setAlmacenes] = useState<AlmacenResumen[]>(initialAlmacenes)
	const [loading, setLoading] = useState(initialAlmacenes.length === 0)
...
export default AlmacenesPageClient
